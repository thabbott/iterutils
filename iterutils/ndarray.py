...
if __name__ == '__main__':
    ...
    print('iter_cartesian(3, 4)')
    for ind in iter_cartesian(3, 4):
        print(ind)

    print('\niter_cartesian(slice(None, 3), slice(None, 4))')
    for ind in iter_cartesian(slice(None, 3), slice(None, 4)):
        print(ind)

    print('\niter_cartesian(slice(1, 3), slice(2, 4))')
    for ind in iter_cartesian(slice(1, 3), slice(2, 4)):
        print(ind)
    
    print('\niter_cartesian(slice(1, 3), slice(2, 4), blocking=(1,1))')
    for ind in iter_cartesian(slice(1, 3), slice(2, 4), blocking=(1,1)):
        print(ind)
    
    print('\niter_cartesian(3, 4, blocking=(2,1))')
    for ind in iter_cartesian(3, 4, blocking=(2,1)):
        print(ind)
    
    print('\niter_cartesian(3, 4, blocking=(1,2))')
    for ind in iter_cartesian(3, 4, blocking=(1,2)):
        print(ind)
    
    print('\niter_cartesian(3, 4, blocking=(1,3))')
    for ind in iter_cartesian(3, 4, blocking=(1,3)):
        print(ind)
    ...
    print('\niter_cartesian(3, 4, blocking=(3,4))')
    for ind in iter_cartesian(3, 4, blocking=(3,4)):
        print(ind)
    
    print('\niter_cartesian(slice(1, 14, 3), slice(3, 7, 3))')
    for ind in iter_cartesian(slice(1, 14, 3), slice(3, 7, 3)):
        print(ind)
    
    print('\niter_cartesian(slice(1, 14, 3), slice(3, 7, 3), blocking=(10,10))')
    for ind in iter_cartesian(slice(1, 14, 3), slice(3, 7, 3), blocking=(10,10)):
        print(ind)
    
    print('\niter_cartesian(slice(1, 14, 3), slice(3, 10, 3), blocking=(3,2))')
    for ind in iter_cartesian(slice(1, 14, 3), slice(3, 10, 3), blocking=(3,2)):
        print(ind)
